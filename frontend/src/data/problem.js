...
class Solution {
  ...
  "merge-k-sorted-lists": {
    ...
    description: {
      ...
      notes: ["Try to do it in O(N log k) time complexity where N is the total number of nodes."],
    },
    examples: [
      {
...
# Test cases
print(solveNQueens(4))  # Expected: [[".Q..","...Q","Q...","..Q."],["..Q.","Q...","...Q",".Q.."]]`,
      java: `import java.util.*;
...
export const PROBLEMS={...PROBLEMS_easy_med,...PROBLEMSHard};
// Object.values(PROBLEMS).forEach((problem)=>console.log(problem.id))